            ...
            <div class="row mb-3">
                <div class="col-xs-12 col-md-6">
                    <div class="card mb-2">
                        ...
                        <p>Piment CSS est un micro-framework css réalisé par la communauté Webmonster.</p>
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="card mb-2">
                        <h4 class="text-blue">
                            <svg width="24" height="24" fill="#0f0ff5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">
                                <path id="face" class="emblem" d="M50,3.3C24.2,3.3,3.3,24.2,3.3,50S24.2,96.7,50,96.7S96.7,75.8,96.7,50S75.8,3.3,50,3.3z M56.1,26.3
                                c4.2,0,7.7,3.4,7.7,7.7s-3.4,7.7-7.7,7.7c-4.2,0-7.7-3.4-7.7-7.7S51.8,26.3,56.1,26.3z M40.2,29.5c2.8,0,5.1,2.3,5.1,5.1
                                c0,2.8-2.3,5.1-5.1,5.1c-2.8,0-5.1-2.3-5.1-5.1C35.2,31.8,37.4,29.5,40.2,29.5z M74.7,58.3c-0.2,0.8-0.5,1.5-0.9,2.3
                                c-2.3,5.2-5.2,8.4-8.5,10.3c-1.1,0.6-2.2,1.1-3.3,1.5c-3.6,1.2-7.6,1.4-12,1.4c-4.2,0-8.5-0.8-12.3-2.3c-1.2-0.5-2.4-1-3.5-1.6
                        ...
                        <p>Github de la communauté Webmonster.</p>
                        <a href="https://github.com/Webmonster-Community" class="option-dark">
                            <span class="circle" aria-hidden="true"><span class="icon arrow"></span></span>
                            <span class="button-text">Github</span>
                        </a>
                    </div>
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="card mb-2">
                        ...
                        <p>Pour débuter son apprentissage du métier de développeur·euse en Martinique il est important de comprendre en quoi il consiste, comment il évolue et ses différents aspects...</p>
                        <a href="https://guides.techmonster.info/" class="option-dark">
                            <span class="circle" aria-hidden="true"><span class="icon arrow"></span></span>
